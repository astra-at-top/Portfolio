...
function Profilelink() {
    return (
        <div className='hidden md:flex text-white fixed top-0 left-10 flex flex-col items-center justify-center z-50'>
            <div className='h-[200px] border-r  bg-gray-800  w-[2px] border-rounded'>
            </div>
